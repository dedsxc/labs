...
*/}}
{{- define "common.lib.statefulset.volumeclaimtemplate" -}}
...
*/}}
{{- define "common.lib.statefulset.volumeclaimtemplates" -}}
  {{- $rootContext := .rootContext -}}
  ...
  {{- range $index, $volumeClaimTemplate := (dig "statefulset" "volumeClaimTemplates" list $statefulsetObject) }}
    {{- $vct := include "common.lib.statefulset.volumeclaimtemplate" (dict "rootContext" $rootContext "values" $volumeClaimTemplate) -}}
