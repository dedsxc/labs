...
*/ -}}
{{- define "common.lib.pod.field.initContainers" -}}
  ...
  {{- range $key, $containerValues := $controllerObject.initContainers -}}
    ...
    {{- if $containerEnabled -}}
      ...
      {{- $containerObject := (include "common.lib.container.valuesToObject" (dict "rootContext" $rootContext "controllerObject" $controllerObject "containerType" "init" "id" $key "values" $containerValues)) | fromYaml -}}
