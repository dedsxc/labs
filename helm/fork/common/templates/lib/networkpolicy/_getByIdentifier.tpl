...
*/}}
{{- define "common.lib.networkpolicy.getByIdentifier" -}}
  ...
  {{- if (hasKey $enabledNetworkPolicies $identifier) -}}
    ...
    {{- include "common.lib.valuesToObject" (dict "rootContext" $rootContext "id" $identifier "values" $objectValues "itemCount" (len $enabledNetworkPolicies)) -}}
  {{- end -}}
{{- end -}}
