...
{{- define "common.render.controllers" -}}
  ...
  {{- else if eq $controllerObject.controller.type "statefulset"  -}}
    {{- $statefulsetObject := (include "common.lib.statefulset.valuesToObject" (dict "rootContext" $rootContext "id" $identifier "values" $controllerObject "itemCount" (len $enabledControllers))) | fromYaml -}}
